...
OpenConferenceWare.configure do |config|
  ...
  config.organization = 'Runway Incubator'

  # Abbreviated name for use in URLs and proposal slugs.
  config.organization_slug = 'rnwy'

  # Top-level tagline or description.
  config.tagline = 'San Francisco\'s premier community for startup, investor and corporate collaboration.'
  ...
  config.app_root_url = 'http://runway.is/community'
